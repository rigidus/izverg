...
if (empty($aDel)) {
	$_t->assign('content', '<span style="color: red">Ошибка:</span> Удаляемая страница не существует!');
	$_t->assign('BreadCrumbs', $BreadCrumbs->getBreadCrumbs());
	return;
}
...
$tpl->assign('h_title', 'Удаление страницы');
$tpl->assign($aDel);
...
Вы действительно хотите удалить страницу <b>{title}</b> ?
